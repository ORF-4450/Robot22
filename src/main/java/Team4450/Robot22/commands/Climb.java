...
/**
 * Climbing command that feeds % power to the Climber motors.
 */
public class Climb extends CommandBase 
{
   ...
   * in the constructor to the climber setClimbPower() function. The provider is
  ...
  public void execute() 
  {
    ...
    if (!robot.isAutonomous())
	    climber.setClimberPower(Util.squareInput(climbPower.getAsDouble()));
  }
